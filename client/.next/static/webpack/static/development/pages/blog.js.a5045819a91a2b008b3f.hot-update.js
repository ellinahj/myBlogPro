...
/*!***********************************!*\
  !*** ./src/actions/base/index.js ***!
  \***********************************/
/*! exports provided: increment, setThemeColor, setLogin, setUserInfo, setCategory, setLoding, setToolTip, setClickMenu, setFont */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setLoding", function() { return setLoding; });
...
var setLoding = function setLoding(payload) {
  return {
...
function ListContainer() {
    ...
    if (getToken) {
      ...
      Object(_api_blog__WEBPACK_IMPORTED_MODULE_7__["getCate"])(config).then(function (res) {
        if (res.status === 200 && res.data) {
          ...
          dispatch(Object(_actions_base__WEBPACK_IMPORTED_MODULE_6__["setCategory"])(res.data.data));
        }
      });
    }
  }, []);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    console.log(category, 'category'); // if (category && category.length > 0) {
...
//# sourceMappingURL=blog.js.a5045819a91a2b008b3f.hot-update.js.map