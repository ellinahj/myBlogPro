...
function ListContainer() {
    ...
    if (getToken) {
      ...
      Object(_api_blog__WEBPACK_IMPORTED_MODULE_7__["getCate"])(config).then(function (res) {
        if (res.status === 200 && res.data) {
          if (category && category.length > 0) {// setSelectedCateId(category[0].id);
          ...
          console.log(clickMenu, 'clicmmcmcmcmcmm');
  ...
  var handleClickAll = function handleClickAll(e) {
    dispatch(Object(_actions_base__WEBPACK_IMPORTED_MODULE_6__["setClickMenu"])({
      index: clickMenu.index,
      cateId: clickMenu.cateId
    }));
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    console.log(clickMenu, 'clickME??'); // if (category && category.length > 0) {
...
//# sourceMappingURL=blog.js.06364e64092a769a334c.hot-update.js.map