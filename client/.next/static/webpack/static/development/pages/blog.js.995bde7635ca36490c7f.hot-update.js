...
function List(props) {
  ...
  return __jsx(ListArea, {
    ...
    })), item && item.image_url.length > 0 ? __jsx(ImageArea, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 31,
    ...
    }, item.image_url.map(function (item) {
      return __jsx(Img, {
        src: item,
        __self: _this,
        __source: {
    ...
    }))) : __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null), __jsx(ContentArea, {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 51,
...
//# sourceMappingURL=blog.js.995bde7635ca36490c7f.hot-update.js.map