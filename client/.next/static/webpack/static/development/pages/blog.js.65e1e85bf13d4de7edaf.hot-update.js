...
function ListContainer() {
  ...
  var getSearch = function getSearch(value) {
    if (blogData && blogData.length !== 0 && value !== '') {
      ...
      if (category && category.length > 0) {
        Object(_api_blog__WEBPACK_IMPORTED_MODULE_7__["getSearchedBlog"])(config, clickMenu.cateId, value).then(function (res) {
          if (res.status === 200) {
            setBlogData(res.data.data);
...
//# sourceMappingURL=blog.js.65e1e85bf13d4de7edaf.hot-update.js.map