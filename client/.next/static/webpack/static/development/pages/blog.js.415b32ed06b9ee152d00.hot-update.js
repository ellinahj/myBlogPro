...
function ListContainer() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    console.log('hi2');
    Object(_api_blog__WEBPACK_IMPORTED_MODULE_7__["getBlog"])(config, clickMenu.cateId).then(function (res) {
      if (res.status === 200) {
        setBlogData(res.data.data);
      }
    });
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    Object(_api_blog__WEBPACK_IMPORTED_MODULE_7__["getBlog"])(config, clickMenu.id).then(function (res) {
      if (res.status === 200) {
        setBlogData(res.data.data);
      }
    });
...
//# sourceMappingURL=blog.js.415b32ed06b9ee152d00.hot-update.js.map