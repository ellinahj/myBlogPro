    ...
    if (getToken) {
      ...
      Object(_src_api_blog__WEBPACK_IMPORTED_MODULE_8__["getCate"])(config).then(function (res) {
        if (res.status === 200 && res.data) {
          dispatch(Object(_actions_base__WEBPACK_IMPORTED_MODULE_11__["setCategory"])(res.data.data)); // console.log(res.data.data, 'rerere');
        }
      });
    }
  }, []);
...
//# sourceMappingURL=post.js.e564ddd44e6c4b79d086.hot-update.js.map