...
})(["width:100%;height:45px;box-sizing:border-box;font-size:15px;background:", ";cursor:", ";text-align:center;line-height:45px;margin-top:20px;margin-bottom:20px;color:#fff;border:none;font-family:'Nanum Myeongjo',serif;"], function (props) {
  return props.allOk ? '#7c7cec' : '#ddd';
}, function (props) {
  return props.allOk ? 'pointer' : 'not-allowed';
});
...
//# sourceMappingURL=join.js.c3258ab04e67f237e530.hot-update.js.map