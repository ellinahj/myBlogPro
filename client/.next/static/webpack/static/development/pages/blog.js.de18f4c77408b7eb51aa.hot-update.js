...
function List(props) {
  ...
  }), blogData && blogData.length === 0 && __jsx(WriteWrap, {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
...
})(["display:flex;flex-direction:column;margin:0 0 30px;width:100%;padding:30px;box-sizing:border-box;border-top:2px dotted ", ";background:#f6f6f6;border-radius:5px;"], function (props) {
...
})(["width:18px;height:18px;background-color:#ddd;border-radius:12px;position:relative;cursor:pointer;:hover{opacity:0.5;}"]);
...
//# sourceMappingURL=blog.js.de18f4c77408b7eb51aa.hot-update.js.map