...
function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function isEdgeSwiping() {
      ...
      var offset = (0, _styleUtilities.getAlignmentOffset)(currentSlide, _objectSpread({}, this.props, {}, this.state));
      ...
      if (this.props.withoutControls) {
        ...
        return this.controlsMap.map(function (_ref) {
          ...
          return controlChildren && _react["default"].createElement("div", {
            ...
            style: _objectSpread({}, (0, _styleUtilities.getDecoratorStyles)(key), {}, _this9.props.getControlsContainerStyles(key))
          }, controlChildren);
        });
      }
    }
